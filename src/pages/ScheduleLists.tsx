  ...
  return (
    <IonPage>
      ...
      <IonCard  className='flex flex-nowrap py-4 bg-white m-0 rounded-none border-0 place-items-center p-15 relative' >
          <IonText className='text-center flex-1 text-black text-2xl'>Residências Santiago</IonText>
          <Icon name="br-route" className='text-center flex-1 text-orange text-4xl py-1/2  m-4'/>
          <IonText className=' text-center flex-1 text-black text-2xl mr-3'>Estação Aveiro</IonText>
      </IonCard>
